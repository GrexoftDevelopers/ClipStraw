...
/**
 * Created by Faizzy on 03-02-2016.
 */

public class DialDotsDrawable extends Drawable {
    private static final String TAG = DialDotsDrawable.class.getSimpleName();
    private Paint mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private float radius;
    private float maxRadius;
    final Rect mDirtyBounds = new Rect(0, 0, 0, 0);

    public DialDotsDrawable(final int color, final float radius, final float maxRadius) {

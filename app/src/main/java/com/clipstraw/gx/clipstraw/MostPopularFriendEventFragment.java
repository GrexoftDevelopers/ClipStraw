 ...
 */
public class MostPopularFriendEventFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        showBrief = true;
        fragmentView = (RecyclerView)inflater.inflate(R.layout.layout_most_popular_friend_events,container,false);
        fragmentView.setHasFixedSize(true);
        fragmentView.setLayoutManager(new LinearLayoutManager(getActivity()));
        fragmentView.setAdapter(new NewsFeedAdapter(getNewsFeed()));
        return fragmentView;
    }
    ...
    private class NewsFeedAdapter extends RecyclerView.Adapter<NewsFeedAdapter.NewsFeedHolder>{
        ...
        public void onBindViewHolder(NewsFeedAdapter.NewsFeedHolder holder, int position) {
            ...
            if(showBrief){
                newsFeedView.findViewById(R.id.news_feed_footer).setVisibility(View.GONE);
                newsFeedView.findViewById(R.id.btn_news_feed_seemore).setVisibility(View.VISIBLE);
            }
            else{
